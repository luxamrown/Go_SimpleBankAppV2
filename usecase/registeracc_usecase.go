...
type RegisterAccountUseCase interface {
	RegisterAccount(id, accountNumber, userName, userPin, userPassword string, balance int) error
}
...
func (r *registerAccountUseCase) RegisterAccount(id, accountNumber, userName, userPin, userPassword string, balance int) error {
